...
class CountdownUi{
    ...
    constructor(){
        ...
        let onDragStartBlackCatPanel = this.OnDragStartBlackCatPanel.bind(this);
        ...
        let onDragStartYellowCatPanel = this.OnDragStartYellowCatPanel.bind(this);
        ...
        this.blackCatPanelElement.ondragstart = onDragStartBlackCatPanel;
        ...
        this.yellowCatPanelElement.ondragstart = onDragStartYellowCatPanel;
    ...
    //当开始拖拽[黑猫]时
    private OnDragStartBlackCatPanel():boolean{
    ...
    //当开始拖拽[黄猫]时
    private OnDragStartYellowCatPanel():boolean{
