...
class TitleBarUi{
    ...
    //元素：设置按钮
    private settingToggleElement:HTMLElement;
    //元素：关闭按钮
    ...
    /* 属性 */
    //元素：设置按钮
    public get SettingToggleElement():HTMLElement{
    ...
    /* 事件 */
    //当点击[设置]按钮时
    private OnClickSettingToggle():void{
    ...
    private OnClickCloseButton():void{
        ...
        //弹出一个“警告框”
        let _isClose:boolean = window.confirm(_tipString);
